...
By default o-expander will collapse content on initialisation. To prevent this add the class `.o-expander__content--expanded` (or `aria-hidden="true"` for the [Hidden Expander](#hidden-rxpander)).
